...
public class Hand {
	...
	private static boolean isFiveOfAKind(ArrayList<Card> cards) {
		...
		for (eRank Rank : eRank.values()){
			...
			for (Card o : cards){
				...
				else if(o.geteRank() == eRank.JOKER){
					cnt++;
				}
			}
			if (cnt == 5){
	...
	public static boolean isHandFiveOfAKind(Hand h, HandScore hs) {
		...
		for (eRank Rank : eRank.values()) {
			...
			for (Card c : h.getCardsInHand()) {
				...
				else if (c.geteRank() == eRank.JOKER){
					iCnt++;
				}
			}
			if (iCnt == 5) {
	...
	public static boolean isHandRoyalFlush(Hand h, HandScore hs) {
		...
		if ((isHandFlush(h.getCardsInHand())) && (isStraight(h.getCardsInHand(), c))) {
			if (c.geteRank() == eRank.ACE || c.geteRank() == eRank.JOKER) {
				isRoyalFlush = true;
	...
	public static boolean isHandNaturalRoyalFlush(Hand h, HandScore hs) {
		...
		if ((isHandFlush(h.getCardsInHand())) && (isStraight(h.getCardsInHand(), c)) && (isHandNaturalFlush(h.getCardsInHand()))) {
	...
	public static boolean isHandFourOfAKind(Hand h, HandScore hs) {
		...
		if (h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank() == h.getCardsInHand()
			...
			hs.setKickers(kickers);
		//JOKERS 
		} else if (h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank() ==  eRank.JOKER && h.getCardsInHand()
				.get(eCardNo.SecondCard.getCardNo()).geteRank() == h.getCardsInHand().get(eCardNo.FourthCard.getCardNo()).geteRank() 
				) {
			bHandCheck = true;
			hs.setHandStrength(eHandStrength.FourOfAKind.getHandStrength());
			hs.setHiHand(h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank().getiRankNbr());
			...
			hs.setKickers(kickers);
				...
				.get(eCardNo.ThirdCard.getCardNo()).geteRank() == h.getCardsInHand().get(eCardNo.FifthCard.getCardNo()).geteRank() 
				) {
			bHandCheck = true;
			hs.setHandStrength(eHandStrength.FourOfAKind.getHandStrength());
			hs.setHiHand(h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank().getiRankNbr());
	...
	public static boolean isHandThreeOfAKind(Hand h, HandScore hs) {
		...
		//JOKERS
			...
			kickers.add(h.getCardsInHand().get(eCardNo.FifthCard.getCardNo()));
				...
				.get(eCardNo.ThirdCard.getCardNo()).geteRank() == h.getCardsInHand().get(eCardNo.FourthCard.getCardNo()).geteRank()) {
			isThreeOfAKind = true;
			hs.setHiHand(h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank().getiRankNbr());
			kickers.add(h.getCardsInHand().get(eCardNo.SecondCard.getCardNo()));
			kickers.add(h.getCardsInHand().get(eCardNo.FifthCard.getCardNo()));
	...
	public static boolean isHandPair(Hand h, HandScore hs) {
		...
		//JOKERS
		    		...
		    		/*
		    		&& h.getCardsInHand().get(eCardNo.SecondCard.getCardNo()).geteRank() != h.getCardsInHand().get(eCardNo.SecondCard.getCardNo()).geteRank()
