...
public class HandTest {
	...
	public void TestFourOfAKindJoker1() {
		...
		FourOfAKind.add(new Card(eSuit.CLUBS,eRank.ACE,0));		
		FourOfAKind.add(new Card(eSuit.CLUBS,eRank.ACE,0));
		FourOfAKind.add(new Card(eSuit.CLUBS,eRank.JOKER,0));
		Collections.sort(FourOfAKind);
		Hand h = new Hand();
		h = SetHand(FourOfAKind,h);
	...
	@Test
	public void TestThreeOfAKindJoker1() {
	...
	@Test
	public void TestThreeOfAKindJoker2() {
	...
	@Test
	public void TestThreeOfAKindJoker3() {
		...
		ThreeOfAKind.add(new Card(eSuit.CLUBS,eRank.FIVE,0));
		ThreeOfAKind.add(new Card(eSuit.CLUBS,eRank.FIVE,0));		
		ThreeOfAKind.add(new Card(eSuit.DIAMONDS,eRank.JOKER,0));
		ThreeOfAKind.add(new Card(eSuit.DIAMONDS,eRank.THREE,0));
		Collections.sort(ThreeOfAKind);
		Hand h = new Hand();
		h = SetHand(ThreeOfAKind,h);
	...
	@Test
	public void TestTwoPairJoker1() {
		
		HandScore hs = new HandScore();
		ArrayList<Card> TwoPair = new ArrayList<Card>();
		TwoPair.add(new Card(eSuit.CLUBS,eRank.JOKER,0));
		TwoPair.add(new Card(eSuit.CLUBS,eRank.TWO,0));
		TwoPair.add(new Card(eSuit.CLUBS,eRank.FIVE,0));		
		TwoPair.add(new Card(eSuit.DIAMONDS,eRank.FIVE,0));
		TwoPair.add(new Card(eSuit.DIAMONDS,eRank.THREE,0));
	...
	public void TestTwoPairJoker3() {
		...
		TwoPair.add(new Card(eSuit.CLUBS,eRank.TWO,0));
		TwoPair.add(new Card(eSuit.CLUBS,eRank.FIVE,0));		
		TwoPair.add(new Card(eSuit.DIAMONDS,eRank.JOKER,0));
		TwoPair.add(new Card(eSuit.DIAMONDS,eRank.KING,0));
		Collections.sort(TwoPair);
		Hand h = new Hand();
		h = SetHand(TwoPair,h);
	...
	public void TestFiveOfAKindJoker() {
		...
		HandScore hs = new HandScore();
		ArrayList<Card> FiveOfAKind = new ArrayList<Card>();
		FiveOfAKind.add(new Card(eSuit.CLUBS,eRank.JOKER,0));
		FiveOfAKind.add(new Card(eSuit.CLUBS,eRank.ACE,0));
		FiveOfAKind.add(new Card(eSuit.CLUBS,eRank.ACE,0));		
		FiveOfAKind.add(new Card(eSuit.CLUBS,eRank.ACE,0));
		FiveOfAKind.add(new Card(eSuit.CLUBS,eRank.ACE,0));
	...
	@Test
	public void TestFiveOfAKindJoker2() {
	...
	@Test
	public void TestFiveOfAKindJoker3() {
	...
	public void TestNaturalRoyalFlush() {
		...
		boolean bActualIsRoyalFlush = Hand.isHandNaturalRoyalFlush(h, hs);
		boolean bExpectedIsRoyalFlush = true;
